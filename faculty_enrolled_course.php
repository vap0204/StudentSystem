...
session_start();
    ...
    $sql = "SELECT * FROM faculty_course WHERE faculty_name = '$name' ";   // a 
...
<body>
    ...
    <br><br>
        <table border="1px">
            ...
            <tr>
                <td class = "table_td"> 
                    <?php echo"{$info['faculty_name']}"; ?>
                </td>

                <td class = "table_td"> 
                    <?php echo"{$info['faculty_course1']}"; ?>
                </td>
                
                <td class = "table_td"> 
                    <?php echo"{$info['faculty_course2']}"; ?>
                </td>

                <td class = "table_td"> 
                    <?php echo"{$info['faculty_course3']}"; ?>
                </td>
