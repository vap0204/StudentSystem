...
session_start();
    ...
    if(isset($_POST['faculty_add_course'])){                                          
        ...
        $sql2 = "INSERT INTO faculty_course (faculty_name,faculty_course1,faculty_course2,faculty_course3) VALUES ('$name','$course_1','$course_2','$course_3')";
        ...
        if($result2){
            ...
            header("location:faculty_enrolled_course.php");
        }
        else{
            echo "Upload Failed";
        }
        ...
        <div>
            ...
            <div class="div_deg">
                ...
                <form action="#" method="POST">
                    ...
                    <div>
                        <input type="submit" class="btn btn-primary" name="faculty_add_course" value="Take course" >
                    </div>
